  ...
  return (
    <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-10">
      <div className="flex flex-col gap-1.5 items-center justify-center text-center">
        <div className="animate-pulse w-[224px] rounded-lg h-[72px] bg-foreground/50" />
        <p>subscribers</p>
      </div>
      <div className="flex flex-col gap-1.5 items-center justify-center text-center">
        <div className="animate-pulse w-[265px] rounded-lg h-[72px] bg-foreground/50" />
        <p>views</p>
      </div>
      <div className="flex flex-col gap-1.5 items-center justify-center text-center">
        <div className="animate-pulse w-[82px] rounded-lg h-[72px] bg-foreground/50" />
        <p>videos</p>
      </div>
    </div>
  );
